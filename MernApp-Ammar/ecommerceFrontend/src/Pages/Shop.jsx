...
let handleCategoryFilterInput=(e)=>{
...
let filteredProducts=selectedCategory==="all"?products:products.filter(p=>p.category._id===selectedCategory)
  ...
  <main>
    ...
    <div className="breadcrumb__area theme-bg-1 p-relative z-index-11 pt-95 pb-95">
      <div
        ...
        data-background="assets/imgs/bg/breadcrumb-bg-furniture.jpg"
      />
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-xxl-12">
            <div className="breadcrumb__wrapper text-center">
              <h2 className="breadcrumb__title">Product</h2>
          ...
          <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-6">
            <div className="product__filter-wrapper d-flex flex-wrap gap-3 align-items-center justify-content-md-end mb-30">
              <div className="bd-product__filter-btn">
                <button type="button">
                  <i className="fa-solid fa-list" /> Filter
                </button>
              </div>
              <div className="product__filter-count d-flex align-items-center">
                <div className="btn-dropdown__options">
                  <select name="fetchThroughCategory" onChange={handleCategoryFilterInput}>
...
return(
                      ...
                      <div className="product-item">
                        ...
                        <div className="product-thumb">
                          <a href="product-details.html">
                            <img
                              src="assets/imgs/product/product1.png"
                              alt=""
                            />
                          </a>
                        </div>
                        ...
                        <div className="product-content">
                          ...
                          <h4 className="product-title">
                            <a href="product-details.html">{prods.name}</a>
                          </h4>
                          <div className="product-price">
                            <span className="product-old-price">
                              <del>${prods.price}</del>
                            </span>
                            <span className="product-new-price">${prods.price}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="product-item">
                        ...
                        <div className="product-content">
                          ...
                          <div className="product-price">
                            ...
                            <span className="product-new-price">$12.00</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                      <div className="product-item">
                        ...
                        <div className="product-thumb">
                          <a href="product-details.html">
                            <img
                              src="assets/imgs/product/product2.png"
                              alt=""
                            />
                          </a>
                        </div>
                        ...
                        <div className="product-content">
                          ...
                          <h4 className="product-title">
                            <a href="product-details.html">Chair pillow</a>
                          </h4>
                          <div className="product-price">
                            <span className="product-old-price">
                              <del>$20.00</del>
                            </span>
                            <span className="product-new-price">$34.00</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                      <div className="product-item">
                        ...
                        <div className="product-thumb">
                          <a href="product-details.html">
                            <img
                              src="assets/imgs/product/product3.png"
                              alt=""
                            />
                          </a>
                        </div>
                        ...
                        <div className="product-content">
                          ...
                          <div className="product-price">
                            ...
                            <span className="product-new-price">$8.50</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                      <div className="product-item">
                        ...
                        <div className="product-thumb">
                          <a href="product-details.html">
                            <img
                              src="assets/imgs/product/product4.png"
                              alt=""
                            />
                          </a>
                        </div>
                        ...
                        <div className="product-content">
                          ...
                          <div className="product-price">
                            ...
                            <span className="product-new-price">$66.00</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                      <div className="product-item">
                        ...
                        <div className="product-thumb">
                          <a href="product-details.html">
                            <img
                              src="assets/imgs/product/product5.png"
                              alt=""
                            />
                          </a>
                        </div>
                    ...
                    <div className="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                      <div className="product-item">
                        ...
                        <div className="product-thumb">
                          <a href="product-details.html">
                            <img
                              src="assets/imgs/product/product6.png"
                              alt=""
                            />
                          </a>
                        </div>
                    ...
                    <div className="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                      <div className="product-item">
                        ...
                        <div className="product-thumb">
                          <a href="product-details.html">
                            <img
                              src="assets/imgs/product/product7.png"
                              alt=""
                            />
                          </a>
                        </div>
                    ...
                    <div className="col-xxl-4 col-xl-4 col-md-6 col-sm-6">
                      <div className="product-item">
                        ...
                        <div className="product-thumb">
                          <a href="product-details.html">
                            <img
                              src="assets/imgs/product/product8.png"
                              alt=""
                            />
                          </a>
                        </div>
        ...
        <div className="row">
          <div className="bd-basic__pagination mt-50 d-flex align-items-center justify-content-center">
            <nav>
              <ul>
                <li>
